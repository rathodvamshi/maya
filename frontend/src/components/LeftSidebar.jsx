...
const LeftSidebar = ({ currentUserEmail, pendingTasks, completedTasks, onOpenModal, onMarkAsDone, onClearChat }) => {
    return (
        <aside className="right-sidebar">
            <div className="sidebar-icons">
                ...
                <div className="sidebar-icon clear-icon" title="Clear Chat" onClick={onClearChat}>
            ...
            <div className="sidebar-content">
                ...
                <div className="sidebar-section">
                    <div className="sidebar-title">
                        ...
                        <button onClick={() => onOpenModal()} className="add-task-btn-icon" title="Add new task">+</button>
                    </div>
                                ...
                                pendingTasks.map(task => (
                                    <li key={task.id} className="task-item">
                                        ...
                                        <div className="task-actions">
                                            <button onClick={() => onOpenModal(task)} className="edit-btn" title="Edit task">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                            </button>
                                            <button onClick={() => onMarkAsDone(task.id)} className="delete-btn" title="Mark as done">
